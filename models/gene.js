// models/gene.js
class Gene {
  constructor(geneName, aliasName, location, maneSelect, mgdId, enzymeId, uniprotIds, hgncId, rgdId, ensemblGeneId, orphanet, dateModified, dateApprovedReserved, validityMarker, omimId) {

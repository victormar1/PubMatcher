<template>
    <div>
        ...
        <div class="flex flex-row items-center border-blue-600">
            <label for="batch" class="block text-3xl ml-16 font-mono font-bold text-gray-700 "> EXTRACT FROM TEXT </label>
            <!-- TOOLTIP CONT -->
        ...
        <div class="flex flex-col items-center w-7/12 space-y-4 rounded min-h-72 overflow-auto  border-red-600  p-4">
            ...
            <form class="w-full max-w-md ">
                ...
                <div class="relative">
                    ...
                    <!-- Search input -->
                    <input type="search" id="phenotypeInput" ref="phenotypeInput" class="block w-full h-full p-4 pl-10 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none" placeholder="Add phenotypes..."  @input="debouncedShowSuggestions('phenotype')" autocomplete="off" @keydown.enter.prevent="addFreePhenotype" required />
                    <!-- Search button -->
...
export default {
    ...
    methods: {
        ...
        console.log('Fetched genes list:', sessionStorage.getItem('genesList'));
        },

<template>
    ...
    <div class="flex justify-center mt-3 ">
                <button type="button" id="researchButton" @click="reasearch" class="text-white justify-center bg-blue-700 hover:bg-blue-800 w-full mx-4 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center h-24 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
